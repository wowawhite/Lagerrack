...
model_parameters = dict(
    ...
    # data preparation
    my_learningsequence="visc6_ultrasonic_ok", #visc6_ultrasonic_ok visc6_nosonic_ok
    ...
    time_steps=300,  # 30 size of sub-sequences for LSTM feeding
    # model learining
    my_epochs=10,  # 10
    my_batch_size=4,  # 32  dimensions of time steps for 2d input pattern

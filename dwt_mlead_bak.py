...
def pad_series(data: np.ndarray) -> np.ndarray:
    ...
    #wt.families()
# valid wavelets 'haar', 'db', 'sym', 'coif', 'bior', 'rbio', 'dmey', 'gaus',
# 'mexh', 'morl', 'cgau', 'shan', 'fbsp', 'cmor'
def multilevel_dwt(data: np.ndarray, wavelet: str = "db10", mode: str = "periodic", level_from: int = 0, level_to=None):
    if level_to is None:
